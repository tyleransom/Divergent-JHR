...
% Create levels figure (Figure B3, panel a)
applicationslevelsfig1(year,[Hfinal OtherApps]);
...
% Create growth figure (Figure B3, panel b)
applicationsgrowthfig1(year,[HfinalGrowth OtherAppsGrowth]);
